 ...
 * {@hide}
 */
public class SkyHLRIL_M extends RIL implements CommandsInterface {
    protected HandlerThread mIccThread;
    protected IccHandler mIccHandler;
    protected String mAid;
    protected boolean mUSIM = false;
    static final String LOG_TAG = "SkyHLRIL_M";
    ...
    public SkyHLRIL_M(Context context, int networkModes, int cdmaSubscription) {
        this(context, networkModes, cdmaSubscription, null);
    }

    public SkyHLRIL_M(Context context, int preferredNetworkType,
